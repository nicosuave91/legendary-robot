...
export function ImportsListPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Imports"
        description="Sprint 9 introduces a governed imports ledger. Files stage first, validate second, and commit only through an explicit server-authoritative step."
      />
