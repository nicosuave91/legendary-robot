        ...
        <AppCard>
          <AppCardHeader>
            ...
            <div className="body-sm text-text-muted">
              Sprint 2 keeps this flow intentionally constrained so the browser never becomes the source of truth.
            </div>
          </AppCardHeader>
          <AppCardBody>
            <ul className="body-sm list-disc space-y-2 pl-5 text-text-muted">
              ...
              <li>Profile confirmation and industry selection persist on the server.</li>
