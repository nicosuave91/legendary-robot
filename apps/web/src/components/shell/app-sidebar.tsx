import { CalendarDays, LayoutGrid, MessageSquare, Settings, Shield, Users, UserRound, PanelLeftClose, PanelLeftOpen } from 'lucide-react'
    ...
    >
      <div className="mb-6 flex items-start justify-between gap-3">
        ...
        <div className="flex flex-col items-end gap-2">
          ...
          {!collapsed ? <AppBadge variant="info">Sprint 2</AppBadge> : null}
        </div>
      </div>
      ...
      {!collapsed ? (
        <div className="mt-8 rounded-lg border border-border bg-muted p-3">
          ...
          <div className="body-sm mt-1 text-text-muted">
            {data?.roles.includes('owner') ? 'Owner bypass active.' : 'Policy-governed onboarding enforced.'}
          </div>
        </div>
      ) : null}
    </aside>
