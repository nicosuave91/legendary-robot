...
return [
    ...
    'info' => [
        ...
        'version' => '2.0.0',
        'description' => 'Sprint 2 identity, auth, onboarding, and account provisioning contracts.',
    ],
    'paths' => [
        '/api/v1/auth/sign-in' => [
            'post' => [
    ...
    'components' => [
        'schemas' => [
            ...
            'OnboardingStateResponse' => [
                ...
                'required' => [
                    'state', 'currentStep', 'isBypassed', 'availableIndustries', 'selectedIndustry', 'profile', 'canComplete',
                ],
            ],
            'ProfileSnapshot' => [
                'type' => 'object',
            ...
            'AccountSummary' => [
                ...
                'required' => ['id', 'email', 'displayName', 'roles', 'onboardingState'],
            ],
            'AccountListEnvelope' => [
                'type' => 'object',
                'properties' => [
