...
return [
    ...
    'components' => [
        'schemas' => [
            ...
            'CommunicationInboxClientSummary' => ['type' => 'object', 'properties' => ['id' => ['type' => 'string'], 'displayName' => ['type' => 'string'], 'status' => ['type' => 'string'], 'ownerDisplayName' => ['type' => 'string', 'nullable' => true], 'primaryEmail' => ['type' => 'string', 'nullable' => true], 'primaryPhone' => ['type' => 'string', 'nullable' => true], 'lastActivityAt' => ['type' => 'string', 'nullable' => true]], 'required' => ['id', 'displayName', 'status', 'ownerDisplayName', 'primaryEmail', 'primaryPhone', 'lastActivityAt']],
            'CommunicationInboxItem' => ['type' => 'object', 'properties' => ['client' => ['$ref' => '#/components/schemas/CommunicationInboxClientSummary'], 'timelineItem' => ['$ref' => '#/components/schemas/CommunicationTimelineItem']], 'required' => ['client', 'timelineItem']],
            'CommunicationsInboxResponse' => ['type' => 'object', 'properties' => ['items' => ['type' => 'array', 'items' => ['$ref' => '#/components/schemas/CommunicationInboxItem']], 'paging' => ['type' => 'object', 'properties' => ['nextCursor' => ['type' => 'string', 'nullable' => true], 'hasMore' => ['type' => 'boolean']], 'required' => ['nextCursor', 'hasMore']], 'filters' => ['type' => 'object', 'properties' => ['search' => ['type' => 'string', 'nullable' => true], 'channel' => ['type' => 'string'], 'status' => ['type' => 'string']], 'required' => ['search', 'channel', 'status']], 'refresh' => ['type' => 'object', 'properties' => ['hasPendingRecentItems' => ['type' => 'boolean'], 'recommendedPollSeconds' => ['type' => 'integer', 'nullable' => true]], 'required' => ['hasPendingRecentItems', 'recommendedPollSeconds']], 'summary' => ['type' => 'object', 'properties' => ['clientCount' => ['type' => 'integer'], 'itemCount' => ['type' => 'integer']], 'required' => ['clientCount', 'itemCount']]], 'required' => ['items', 'paging', 'filters', 'refresh', 'summary']],
            ...
            'CommunicationsInboxEnvelope' => ['type' => 'object', 'properties' => ['data' => ['$ref' => '#/components/schemas/CommunicationsInboxResponse'], 'meta' => ['$ref' => '#/components/schemas/ResponseMeta']], 'required' => ['data', 'meta']],
